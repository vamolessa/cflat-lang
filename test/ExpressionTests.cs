...
public sealed class ExpressionTests
{
	...
	[InlineData("{let mut a=false true or {a=true false} a}", false)]
	[InlineData("{let mut a=false false and {a=true true} a}", false)]
	...
	[Theory]
	[InlineData("{let mut a=4 a=a+1 a}", 5)]
	[InlineData("{let mut a=4 a=a=5 a}", 5)]
	[InlineData("{let mut a=4 a=a=a+1 a}", 5)]
	[InlineData("{let mut a=4 let mut b=5 b+1 a=b=7 a}", 7)]
