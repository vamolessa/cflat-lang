namespace cflat
{
	public static class CFlatInterfaceExtensions
	{
		...
		public static bool AddFunction<A0, R>(this CFlat self, string functionName, System.Func<A0, R> function)
		...
		public static bool AddFunction<A0, A1, R>(this CFlat self, string functionName, System.Func<A0, A1, R> function)
			where A0 : struct, IMarshalable
		...
		public static bool AddFunction<A0, A1, A2, R>(this CFlat self, string functionName, System.Func<A0, A1, A2, R> function)
			where A0 : struct, IMarshalable
			where A1 : struct, IMarshalable
