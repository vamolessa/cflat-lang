namespace cflat
{
	...
	public readonly struct Unit : IMarshalable
	{
		...
		public ValueType GetType(ByteCodeChunk chunk)
		{
			global::cflat.Marshal.SizeOf<Unit>.size = 1;
	...
	public struct Bool : IMarshalable
	{
		...
		public ValueType GetType(ByteCodeChunk chunk)
		{
			global::cflat.Marshal.SizeOf<Bool>.size = 1;
	...
	public struct Float : IMarshalable
	{
		...
		public ValueType GetType(ByteCodeChunk chunk)
		{
			global::cflat.Marshal.SizeOf<Float>.size = 1;
	...
	public struct String : IMarshalable
	{
		...
		public ValueType GetType(ByteCodeChunk chunk)
		{
			global::cflat.Marshal.SizeOf<String>.size = 1;
	...
	public struct Ref<T> : IMarshalable where T : struct, IMarshalable
	{
		...
		public ValueType GetType(ByteCodeChunk chunk)
		{
			global::cflat.Marshal.SizeOf<Ref<T>>.size = 1;
			return global::cflat.Marshal.TypeOf<T>(chunk).ToReferenceType(false);
		}
